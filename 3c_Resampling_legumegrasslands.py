# 3d_recode_legume_ackergrass_share_to_score.py
# Recode Legume_Ackergrass_Share.tif classes to float scores and write to Intermediates_resampled.
#
# Rules (user-defined):
#   0     -> 0.125
#   1     -> 0.500
...
# 1) INPUTS / OUTPUTS
# ============================================================
IN_TIF = r"D:\The New Folder\Master_arbeit\DLR_Data\Intermediates\Legume_Ackergrass_Share.tif"
OUT_DIR = r"D:\The New Folder\Master_arbeit\DLR_Data\Intermediates\Intermediates_resampled"
OUT_NAME = "Legume_Ackergrass_Share_score_float.tif"
